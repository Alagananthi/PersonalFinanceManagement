...
from chart import show_expense_pie_chart  
...
def finance_menu(user_id):
    while True:
        ...
        if choice == '1':
            ...
            show_expense_pie_chart(user_id) 
            break
        else:
...
def main():
    initialize_db()
    print(" Welcome to PersonalFinance ")
    ...
    while True:
        ...
        if choice == '1':
            ...
            print("Stay smart with your money. See you next time!!")
            break
        else:
            print("Invalid choice!")
